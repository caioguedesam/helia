...
#define DEFINE_UNIFORM_BLOCK(SET, BINDING)  layout(std430, set = SET, binding = BINDING) uniform CONCAT(UNIFORM_BLOCK_, __LINE__)
...
#define DEFINE_IMAGE2D(SET, BINDING)      layout(set = SET, binding = BINDING) uniform image2D
